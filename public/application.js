...
/***/ (function(module, exports, __webpack_require__) {
	...
	var calcEvents = __webpack_require__(32);
	...
	var setAPIOrigin = function setAPIOrigin(location, config) {
	  ...
	  if (search.environment === 'development' || location.hostname === 'localhost' && search.environment !== 'production') {
	    if (!(config.apiOrigin = config.apiOrigins.development)) {
	      ...
	      config.apiOrigin = 'http://localhost:' + 4741;
	    }
	  } else {
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://franklin-budget-calculator.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(data).done([ui.signUpSuccess, function (response) {
	    api.signIn(data).done(ui.signInSuccess);
	...
	var onSignIn = function onSignIn(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.signIn(data).then(ui.signInSuccess).then(api.indexCashflow).then(ui.indexCashflowSuccess).catch(ui.signInFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addCashflow = function addCashflow(data) {
	  return $.ajax({
	...
	var deleteCashflow = function deleteCashflow(id) {
	  return $.ajax({
	...
	var indexCashflow = function indexCashflow() {
	  return $.ajax({
	    url: config.apiOrigin + '/cashflows',
	    method: 'GET',
	    // require user to be signed-in before creating new cashflow
	...
	var updateCashflow = function updateCashflow(id, data) {
	  return $.ajax({
	    url: config.apiOrigin + '/cashflows/' + id,
	    method: 'PATCH',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showCashflowsTemplate = __webpack_require__(12);
	var store = __webpack_require__(10);
	var inputValue = function inputValue(target) {
	  return $(target).val();
	};
	// function to target the needed values and push them to the empty array
	var valuesToArray = function valuesToArray(object, array) {
	...
	var addCashflowSuccess = function addCashflowSuccess(data) {
	  store.cashflow = data.cashflow;
	};

	var addCashflowFailure = function addCashflowFailure(error) {
	  return error;
	};

	var deleteCashflowSuccess = function deleteCashflowSuccess(data) {};

	var deleteCashflowFailure = function deleteCashflowFailure(error) {
	  return error;
	};

	var indexCashflowSuccess = function indexCashflowSuccess(data) {
	  // empty array to house values to be added together
	  var cashflowValueArray = [];
	  ...
	  var netCashflow = cashflowValueArray.reduce(function (sum, value) {
	    return sum + value;
	  }, 0);
	  ...
	  var showCahflowsHTML = showCashflowsTemplate({ cashflows: data.cashflows });
	  $('.content').append(showCahflowsHTML);
	  store.cashflow = data.cashflow;
	};

	var indexCashflowFailure = function indexCashflowFailure(error) {
	  return error;
	};

	var updateCashflowSuccess = function updateCashflowSuccess(data) {
	  store.cashflow = data.cashflow;
	};

	var updateCashflowFailure = function updateCashflowFailure(error) {
	  return error;
	};
	...
	module.exports = {
	  ...
	  addCashflowSuccess: addCashflowSuccess,
	  addCashflowFailure: addCashflowFailure,
	  deleteCashflowSuccess: deleteCashflowSuccess,
	  deleteCashflowFailure: deleteCashflowFailure,
	  indexCashflowSuccess: indexCashflowSuccess,
	  indexCashflowFailure: indexCashflowFailure,
	  updateCashflowSuccess: updateCashflowSuccess,
	  updateCashflowFailure: updateCashflowFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<h1>CASHFLOW LIST</h1>\n<form class=\"update-cashflow\">\n        <fieldset>\n          <input type=\"submit\" name=\"submit\" class=\"update-button clear-input\" value=\"Update\">\n          <input type=\"hidden\" name='cashflow[id]' class=\"hide-id\">\n          <input type=\"text\" name='cashflow[name]' class=\"input cashflow-name clear-input\">\n          <input type=\"number\" step=\"0.01\" name='cashflow[value]' class=\"input cashflow-value\">\n        </fieldset>\n      </form>\n<form class='delete-cashflow'>\n  <fieldset>\n    <input type=\"hidden\" name='cashflow[id]' value= "
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.cashflow : depth0)) != null ? stack1.id : stack1), depth0))
	    + ">\n    <td><input type=\"submit\" name=\"submit\" class=\"delete-button\" value=\"delete\"></td>\n  </fieldset>\n</form>\n<table class=\"table table-striped table-condensed table-responsive table-bordered\">\n  <thead>\n    <tr>\n      <th>Name</th>\n      <th>Amount</th>\n    </tr>\n  </thead>\n  <tbody>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.cashflows : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</tbody>\n</table>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var rowSelector = function rowSelector() {
	  ...
	  var name = $('.selected').children().html();
	  // get cashflow value of selected row
	  var value = $('.selected td:eq(1)').text();
	...
	var onAddCashflow = function onAddCashflow(event) {
	  event.preventDefault();
	  ...
	  // on success
	  .then(ui.addCashflowSuccess).then(api.indexCashflow).then(ui.indexCashflowSuccess)
	  // on failure
	  .catch(ui.addCashflowFailure);
	};

	var onDeleteCashflow = function onDeleteCashflow(event) {
	  event.preventDefault();
	...
	var onUpdateCashflow = function onUpdateCashflow(event) {
	  event.preventDefault();
	  var target = $('.selected');
	  // get the data-id of the selected row
	  ...
	  // on success
	  .then(ui.updateCashflowSuccess).then(api.indexCashflow).then(ui.indexCashflowSuccess)
	  // on failure
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "760e90b0c53f42fbf0f286178c4f305b.jpg";
